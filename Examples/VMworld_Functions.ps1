...
$opsDemoSteps = @(
    ...
    # {Get-NsxIpSet BookstoreLB | Add-NsxIpSetMember -IPAddress 172.16.1.2,172.16.1.3},
    ...
    # # {Get-NsxFirewallSection bookstore | Get-nsxfirewallrule | Add-NsxFirewallRuleMember -MemberType Source -Member (Get-NsxIpSet WordpressLB-VIP)},
    # # {Get-nsxfirewallrule | Get-NsxFirewallRuleMember | where-object {$_.name -eq 'WordpressLB-VIP'} | Remove-NsxFirewallRuleMember },
    # # {get-nsxfirewallrule -ruleid $rule.id | get-nsxfirewallrulemember |ft}
    ...
    {get-nsxservice -port 44000 | select name,@{Name="Protocol"; Expression={$_.element.applicationprotocol}},@{Name="Port"; Expression={$_.element.value}}},
    {Get-NsxSecurityGroup sgEnvProd},
    {Get-NsxSecurityGroup sgEnvProd | Get-NsxSecurityGroupEffectiveVirtualMachine}
    {Get-NsxSecurityTag | ft},
